...
public class FoodwasteFragment extends Fragment {
    ...
    public static FoodwasteFragment newInstance(){
        return new FoodwasteFragment();
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_foodwaste, container, false);
